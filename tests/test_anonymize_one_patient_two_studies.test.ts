...
describe("patient", () => {
  ...
  beforeEach(() => {
    ...
    dataset1 = loadInstance(1, 1);
    dataset2 = loadInstance(1, 2);
  });

  it.sequential("should anonymize patient attributes the same", async () => {
  ...
  it.sequential("should anonymize study, series and instance attributes differently", async () => {
    const elementPaths = [
      // study
